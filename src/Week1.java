...
public class Week1 {
    public static void main(String[] args) throws Exception {
        ...
        collection2.add("Los Angelas");
        collection2.add("Atlanta");

        System.out.println(collection2.size() + " cities in collection2");
        ...
        System.out.println("\nCities only in collection1 but not in collection2: ");
        System.out.println(c1);

        c1 = (ArrayList<String>)(collection1.clone());
        c1.addAll(collection2);
        c1.removeAll(collection1);
        System.out.println("\nCities in collection2 but not in collection1");
        System.out.println(c1);
    }
}
